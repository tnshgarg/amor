  ...
  const features = [
    {
      ...
      description: "Our advanced AI turns your unique love story into a beautiful, personalized song that captures your journey together.",
      icon: <Music className="h-8 w-8 text-love-500" />
    },
    {
      title: "Story to Melody",
      description: "Share your love story, how you met, special moments, and let our AI craft lyrics that truly represent your relationship.",
      icon: <MessageSquare className="h-8 w-8 text-love-500" />
    },
    {
      title: "Perfect Gift",
      description: "Surprise your partner with a one-of-a-kind gift that celebrates your unique love story in melody and words.",
      icon: <Heart className="h-8 w-8 text-love-500" />
    },
    {
      title: "Premium Quality",
      description: "Professional-grade productions with various genres and styles to match your relationship's unique vibe and energy.",
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <video
            ...
            playsInline
          >
            <source src="https://cdn.coverr.co/videos/coverr-couple-holding-hands-on-beach-at-sunset-2541/1080p.mp4" type="video/mp4" />
      ...
      <section className="py-20 bg-love-50 dark:bg-love-900/10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl font-bold mb-4">Turn Your Love Story Into Music</h2>
            <p className="text-lg text-foreground/70">
              AmorAI transforms your unique relationship journey into beautiful, personalized songs that capture the essence of your love.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-foreground/70">
              Creating your personalized love song is simple with our AI-powered platform.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-foreground/70">
                Tell us about your relationship journey, special moments, and what makes your love unique.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-3">AI Creates Your Song</h3>
              <p className="text-foreground/70">
                Our advanced AI analyzes your story and composes unique lyrics and melody that capture your relationship.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-foreground/70">
                Download your song, share it with your loved one, and create a lasting memory of your relationship.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <motion.p 
              ...
              transition={{ duration: 0.5, delay: 0.1 }}
            >
              Create a timeless, personalized song that captures the essence of your relationship. The perfect gift for anniversaries, weddings, or just because.
            </motion.p>
