        ...
        >
          {credits > 0 ? (
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-50 dark:bg-amber-950/20 border border-amber-100 dark:border-amber-800/30">
              ...
              <span className="text-amber-700 dark:text-amber-300">You have no credits - purchase some on the <Button onClick={() => navigate('/pricing')} variant="link" className="p-0 text-amber-500 hover:text-amber-600 h-auto">pricing page</Button></span>
            </div>
          )}
        </motion.div>
          ...
          >
            ...
            <div className="mb-6">
              ...
              <div className="mt-2 text-sm text-muted-foreground">
                <p>The more details you provide, the more personalized your song will be.</p>
                <div className="mt-3">
